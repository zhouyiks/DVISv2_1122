...
class ViHub_online(MinVIS):
    ...
    def from_config(cls, cfg):
        ...
        weight_dict = {"loss_ce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight,
                       ...
                       "warming_loss_ce": class_weight, "warming_loss_mask": mask_weight,
                       "warming_loss_dice": dice_weight}
        ...
        tracker = VideoInstanceCutter(
            hidden_dim=cfg.MODEL.MASK_FORMER.HIDDEN_DIM * 2,
            ...
            warming_layer_num=cfg.MODEL.VIDEO_HEAD.NUM_WARMING_LAYERS,
        )
    ...
    def forward(self, batched_inputs):
        ...
        # for targets_i in video_targets:
        #     print(targets_i[0]["disappear_inst"])

        stage = 1
        if self.using_thr and self.iter >= self.max_iter_num // 2:
            stage = 2
        self.iter += 1
        outputs = self.tracker(frame_embeds_no_norm, frame_reid_embeds, mask_features, video_targets, frame_indices_info,
                               self.aux_matcher, using_thr=self.using_thr, stage=stage)
