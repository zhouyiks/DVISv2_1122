        ...
        for i in range(T):
            ...
            if i == 0 and resume is False:
                ...
                for j in range(self.num_layers):
                    output = self.transformer_cross_attention_layers[j](
                        ms_output[-1], src,
                        query_pos=pilot_pos, pos=src_pos,
            ...
            if i > 0:
                ...
                for src_i, tgt_i in zip(self.prev_frame_indices[0], self.prev_frame_indices[1]):
                    if self.disappear_tgt_id is not None and tgt_i == self.disappear_tgt_id.item():
                        continue
                    ...
                    negative_embedding = curr_reid_embeds[negative_query_id_2, 0, :]
                    reid_out = {
