            ...
            if i == 0 and resume is False:
                ...
                if using_thr:
                    ...
                    if self.disappear_trcQ_id is not None:
                        ...
                        # if not continuously_disappear and random.random() > 0.3:
                        #     continuously_disappear = True
                        # if continuously_disappear:
                        #     valid_track_query[self.disappear_trcQ_id] = True

                    # # model newly born
                    # if torch.any(valid_track_query):
                    ...
                    #     if select_tgt_id == -1:
                    #         pass
                    #     elif len(self.new_born_tgt_ids) > 0 or select_tgt_id in self.new_born_tgt_ids:
                    #         pass
                    #     elif self.disappear_tgt_id is None or self.disappear_tgt_id != select_tgt_id:
                    #         valid_track_query[tgt_ids_for_each_query == select_tgt_id] = False
